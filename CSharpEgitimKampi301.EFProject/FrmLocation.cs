...
namespace CSharpEgitimKampi301.EFProject
{
    public partial class FrmLocation : Form
    {
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            location.Capacity = byte.Parse(nudCapatiy.Value.ToString());
            location.City = txtCity.Text;
            location.Country = txtCountry.Text;
            location.Price = decimal.Parse(txtPrice.Text);
            location.DayNight = txtDayNight.Text;
            location.GuideId = int.Parse(cmbGuid.SelectedValue.ToString());
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            updatedValue.Capacity = byte.Parse(nudCapatiy.Value.ToString());
            updatedValue.City = txtCity.Text;
            updatedValue.Country = txtCountry.Text;
            updatedValue.Price = decimal.Parse(txtPrice.Text);
            updatedValue.DayNight = txtDayNight.Text;
            updatedValue.GuideId = int.Parse(cmbGuid.SelectedValue.ToString());
            db.SaveChanges();
